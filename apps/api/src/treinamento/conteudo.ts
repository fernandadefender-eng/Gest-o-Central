...
export const MODULOS: Modulo[] = [
  ...
  },
  {
    ...
    licoes: [
      ...
      { titulo: 'Procedimento em campo — APROPRIAÇÃO INDÉBITA', pontos: [
        'Verificar se a placa confere com o veículo.',
        'Verificar a gravação do chassi nos vidros do veículo.',
        'Se possível, fazer contato com o locatário ou possuidor.',
        'Realizar a vistoria do veículo junto com o locatário/possuidor.',
        'Fazer o laudo fotográfico apontando todas as avarias ou partes faltantes.',
        'Solicitar a chave do veículo e mantê-la em posse até a chegada do guincho.',
        'De posse da chave, ela NÃO volta para o locatário/possuidor — o desbloqueio das portas para retirar objetos é feito pelo agente.',
        'Pedir que o locatário/possuidor retire seus objetos pessoais.',
        'Em hipótese alguma o locatário/possuidor retira peças ou bateria do veículo apreendido.',
      ] },
      { titulo: 'Procedimento em campo — ROUBO ou FURTO', pontos: [
        'No marco zero, verificar se há veículos com as mesmas características do roubado/furtado.',
        'Verificar a gravação do chassi nos vidros (as placas podem já ter sido trocadas).',
        'Verificar se a placa confere com o veículo e se ele está trancado.',
        'Fazer o laudo fotográfico das avarias/partes faltantes.',
        'Antes de chamar o proprietário com a chave reserva, ver se o veículo tem bateria/condições de deslocamento.',
        'Com o proprietário no local: pegar nome completo, documento (se possível), celular e informar a central.',
        'Na presença do proprietário, novo laudo fotográfico + vídeo da vistoria, e enviar para a central.',
        'Aguardar o encerramento pela central; pode haver deslocamento para a delegacia.',
      ] },
      { titulo: 'Segurança do agente (roubo/furto)', pontos: [
        'Qualquer movimentação estranha no local: informar a central IMEDIATAMENTE.',
        'Se possível, ligar para o 190.',
        'O agente deve procurar um local seguro.',
      ] },
    ],
    questoes: [
      ...
      { id: 've5', dificuldade: 2, enunciado: 'Apropriação indébita: quem fica com a chave até o guincho chegar?', opcoes: ['O locatário', 'O agente — e ela não volta para o locatário', 'A central', 'Ninguém'], certa: 1, explicacao: 'A chave fica com o agente; o desbloqueio para retirar objetos é feito por ele.' },
      { id: 've6', dificuldade: 3, enunciado: 'Roubo/furto: por que conferir o chassi nos vidros mesmo com a placa certa?', opcoes: ['Por estética', 'As placas podem ter sido trocadas no veículo sinistrado', 'Não precisa', 'Para o laudo do valor'], certa: 1, explicacao: 'Confere a identidade real do veículo — placas podem ter sido trocadas.' },
      { id: 've7', dificuldade: 1, enunciado: 'Movimentação estranha no local da recuperação. O agente deve...', opcoes: ['Continuar normalmente', 'Informar a central na hora, ligar 190 se possível e ir para local seguro', 'Ir embora sem avisar', 'Abordar as pessoas'], certa: 1, explicacao: 'Segurança primeiro: central, 190 e local seguro.' },
      { id: 've8', dificuldade: 2, enunciado: 'Apropriação indébita: o possuidor pode retirar a bateria do veículo apreendido?', opcoes: ['Pode', 'Em hipótese alguma', 'Só com autorização', 'Se for dele'], certa: 1, explicacao: 'Nunca retira peças ou bateria do veículo apreendido.' },
    ],
  },
  {
